...
export default async function handler(req, res) {
  ...
  if (action === 'login') {
          const scope = [
                    ...
                    'mfc/accounting/journals.read',
                    'mfc/accounting/partners.read',
                    'mfc/accounting/sections.read',
  ...
  if (action === 'refresh') {
        ...
        if (fetchErr || !tokenRow) return res.status(401).json({ error: 'No token found.' });
